...
import profileImageUrl from "@/public/profile.jpeg";
...
export default function Intro() {
  ...
  return (
    ...
    >
        ...
        <div className="relative">
          ...
          >
            <Image
              ...
              quality="100"
              priority={true}
              className="h-60 w-60 rounded-full object-cover object-top border-[0.35rem] border-white shadow-xl"
            />
          </motion.div>
      ...
      >
        <span className="font-bold">Hello, I'm Ali Hassan.</span> I'm a{" "}
      ...
      >
        ...
        <a
          ...
          href="/Ali Hassan Resume.pdf" // <-- Corrected path
          download
        >
          Download CV{" "}
        ...
        <a
          ...
          href="https://www.linkedin.com/in/mralihassan02/"
          target="_blank"
        >
          <BsLinkedin />
        </a>
        ...
        <a
          ...
          href="https://github.com/Ali-Hassan02"
          target="_blank"
        >
          <FaGithubSquare />
        </a>
